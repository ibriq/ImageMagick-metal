...
MAGICK_DEBUG=Accelerate ./utilities/magick $LARGE_IMAGE -contrast null: 2>&1 | grep "Metal device created successfully" || echo "WARNING: Metal not detected during benchmark!"
